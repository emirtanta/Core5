    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    UserName = Input.Email, //kullanıcı adı email adresi oldu
                    Email=Input.Email,
                    Name=Input.Name,
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        //roller arasında Admin yoksa ekler. İstediğimiz kadar satır yazarak istediğimiz rolü veritabanına aktarbiliriz
                        await _roleManager.CreateAsync(new IdentityRole(Diger.Role_Admin));
                    }

                    //admin rolünü kullanıcıya verdik
                    await _userManager.AddToRoleAsync(user, Diger.Role_Admin);

                    #region Email Doğrulama Bölümü
