...
namespace OrnekSite.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        //email adresi onaylanmış kişiler sipariş verilmesi için tanımlandı
        ...
        public IActionResult Index()
        {
            ...
            /* kullanıcı  bulur bitti */

            //sepetteki tüm ürünleri getirdik
            ...
            //başlangıçta ürün toplam 0 oldu
            ShoppingCartVM.OrderHeader.OrderTotal = 0;

            //sepete ürün ekleyen kullanıcıyı getirir
        ...
        /* email doğrulanmayan adresler sipariş ver butonunu göremez bu kısım isteğe bağlı */
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            //kullanıcı gerçek bir email adresi girmemişse
            if (user == null)
            {
        ...
        /* email doğrulanmayan adresler sipariş ver butonunu göremez bu kısım isteğe bağlı bitti */

        #region Sepetteki Ürün Adetini Butona Basınca Arttırma Bölümü
        ...
        #region Sepetteki Ürün Adetini Butona Basınca Azaltma Bölümü
        ...
        public IActionResult Decrease(int cartId)
        {
            ...
            if (cart.Count == 1)
            {
                ...
                // eksi butonuna basılınca ürün sayısı 1 ise ürünü sepetten siler
                HttpContext.Session.SetInt32(Diger.ssShoppingCart, count - 1);
            }

            //ürün sayısı 1'den büyükse
            else
            {
                cart.Count -= 1;
        ...
        public IActionResult Summary(ShoppingCartVM model)
        {
            ...
            /* iyzico ayarları bitti  */

            //sipariş verildiğinde kullanıcının sepeti temizlenir
            _db.ShoppingCarts.RemoveRange(ShoppingCartVM.ListCart);

            _db.SaveChanges();

            //Session'daki bilgiler silinir
        ...
        private Payment PaymentProcess(ShoppingCartVM model)
        {
            ...
            options.ApiKey = "sandbox-SOswFROBje14VraLYWC4L7yviwvFFg0B";
            options.SecretKey = "sandbox-X7jrSr7HRlaCy2fns5YDGuYrKP2iukKk";
            ...
            //kullanıcının sepetinde bulunan ürünleri getiridik
