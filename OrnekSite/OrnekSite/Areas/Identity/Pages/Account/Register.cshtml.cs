...
namespace OrnekSite.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //sistemdeki rolleri dropdown olarak getirir
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            /* sistemdeki rolleri dropdown içerisine getirme */
            ...
            /* sistemdeki rolleri dropdown içerisine getirme bitti */
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    /* Kullanıcı için admin,User,Birey rolü oluşturma */
                    ...
                    /* Kullanıcı için admin,User,Birey rolü oluşturma bitti */

                    //sendgrid tanımlanında bu yorum satırlarını aktif et (email doğrulama için geçerli
                    ...
                    //sendgrid tanımlanında bu yorum satırlarını aktif et bitti
